...
```{r transition,warning=FALSE,fig.width = 5, fig.height = 9,fig.cap = "Detection of a single shifting point in the time series through the minimisation of the residual squared sum (RSS) for the estimated parameters (A-B). The analyses show the date when the shift occurred (red segmented line). (C) The total number of active cases and (D) the average number of active cases over time."}
