...
```{r transition,warning=FALSE,fig.width = 5, fig.height = 9,fig.cap = "Detection of a single shifting point in the time series through the minimisation of the residual squared sum (RSS) for the estimated parameters (A-B). The analyses show the shift occurring the 28th of February (red segmented line). (C) The mean proportional abundance over time (log-scale) with the projected tipping point from (A-B)."}
