...
```{r treemap, echo=FALSE, fig.cap="Proportional abundance distribution by country."}
ggplot(propab_df[propab_df$date == max(propab_df$date),], aes(area = propAb, fill = Country)) +
  geom_treemap() +
ggtitle(format(Sys.time(), "%d of %b %Y")) +
